...
DEFINE_BUILTIN_NAME(PdfPicturePDF)

CPdfPicturePDF::CPdfPicturePDF(void)
{
	mulPageCount = 0;
...
void CPdfPicturePDF::CloseFile(bool nbUpdateView)
{
...
bool CPdfPicturePDF::PageFoward(bool foward)
{
...
ULONG CPdfPicturePDF::GetCurrentPageNumber(ULONG& secondPage)
{
	if (pdfCrtPage == NULL)
		return 0;
...
void CPdfPicturePDF::EnableDuopageView(bool nbEnable)
{
...
bool CPdfPicturePDF::CopyToClipboard(const D2D1_RECT_F& rRegion)
{
...
float CPdfPicturePDF::GetFatRatio(void)
{
...
IEdPage_ptr CPdfPicturePDF::loadPage(int32 pageNo, ED_SIZE& sizeInit)
{
...
bool CPdfPicturePDF::RenderPages(void)
{
	bool lbRet = false;
...
void CPdfPicturePDF::CalcMovalbe(OUT RECT& rMove)
{
	ED_RECT dstRect;
	ED_RECT srcRect;
	UCHAR edgeImpact;
...
void CPdfPicturePDF::GetRectOfViewportOnPage(D2D1_SIZE_F& nrImageSize, D2D1_RECT_F& nrViewPort)
{
