...
DECLARE_BUILTIN_NAME(ZoomControlTxt)


class CZoomControlTxt:
	public CXuiElement<CZoomControlTxt,GET_BUILTIN_NAME(ZoomControlTxt)>
{
	friend CXuiElement<CZoomControlTxt,GET_BUILTIN_NAME(ZoomControlTxt)>;
...
private:
	...
	CZoomControlToolbarTxt* mpZoomControlTxtToolbar;
