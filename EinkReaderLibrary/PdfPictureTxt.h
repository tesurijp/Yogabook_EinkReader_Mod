...
DECLARE_BUILTIN_NAME(PdfPictureTxt)

class CPdfPictureTxt:
	public CXuiElement<CPdfPictureTxt,GET_BUILTIN_NAME(PdfPictureTxt)>
{
	friend CXuiElement<CPdfPictureTxt,GET_BUILTIN_NAME(PdfPictureTxt)>;
