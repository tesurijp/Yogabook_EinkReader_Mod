...
private:
	...
	IEinkuiIterator* mpIterTxt; //用于显示txt文件
	HANDLE mHandleTxtFile; //txt文件句柄
	wchar_t* mpwcharTxt;
	char* mpcharTxt;
	int miTxtFontSizeIndex;
	int miFontSize[5];  //5档大小的字体
	int miFontPage[5];  //5档大小字体对应的一页能显示多个字符
...
#define PP_LABEL_TXT 1 

#define TXT_MAX_LEN 5000