...
#import "./import/MSPPT.OLB" \
	raw_interfaces_only, \
	auto_rename, \
    rename( "DialogBox", "PowerPointDialogBox" ), \
    rename( "RGB", "PowerPointRGB" ), \
    rename( "CopyFile", "PowerPointCopyFile" ), \
    rename( "ReplaceText", "PowerPointReplaceText" ), \
...
namespace PDFConvert
{
	...
	{
		if (!ConvertUtil::PowerPointInstalled())
		{
		...
		CloseOfficeDefaultWarning(L"PowerPoint");//Word/PowerPoint/Excel/Visio
